...
uint get_total_signal_no() {return 10299;}

uint get_number_of_components() {return 387;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 4541;}
...
CommitmentHasher_5_create(1,0,ctx,"main",0);
CommitmentHasher_5_run(0,ctx);
}
